...
// import product from "../../../studio-e-commerceweb/schemaTypes/product";
...
<Link className="text-primary flex items-center gap-x-1" href="/all ">See All{" "} <span><ArrowBigRight /> </span></Link>
</div>
